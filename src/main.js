...
function renderHomePage() {
  document.querySelector('#app').innerHTML = `
    <div class="min-h-screen flex flex-col items-center justify-start bg-[#25305a] px-3 py-6">
      <header class="w-full flex flex-col items-center mt-2 mb-6">
        <h1 class="text-4xl font-extrabold text-[#6ee900] font-[Quicksand,sans-serif] mb-2" style="letter-spacing: -1px;">Globo Quiz</h1>
        <p class="text-white text-lg font-medium">Aventura mundial de Geografía</p>
      </header>
      <img src="/globo-quiz-globe.gif" alt="Globo animado" class="mt-2 mb-12 w-auto" style="height: 30vh; max-width: 100%; object-fit: contain;" />
      <div class="flex flex-col gap-6 w-full max-w-md mt-10">
        <div class="flex items-center bg-white rounded-2xl shadow-md px-4 py-5 mode-card" id="mode-capitales">
          <div class="flex-shrink-0 w-16 h-16 rounded-full bg-purple-100 flex items-center justify-center mr-4 overflow-hidden">
          ...
          <div>
            <div class="text-xl font-bold text-gray-800">Capitales</div>
            <div class="text-gray-500 text-base leading-tight">Adivina las capitales de países de todo el mundo</div>
          </div>
        </div>
        <div class="flex items-center bg-white rounded-2xl shadow-md px-4 py-5 mode-card" id="mode-banderas">
          <div class="flex-shrink-0 w-16 h-16 rounded-full bg-yellow-100 flex items-center justify-center mr-4 overflow-hidden">
            <svg width="56" height="56" viewBox="0 0 112 112" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            <div class="text-xl font-bold text-gray-800">Banderas</div>
            <div class="text-gray-500 text-base leading-tight">Identifica a qué país pertenece cada bandera</div>
          </div>
        </div>
      </div>
    </div>
