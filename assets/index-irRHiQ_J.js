(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function t(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(e){if(e.ep)return;e.ep=!0;const o=t(e);fetch(e.href,o)}})();const R="/globo-quiz/assets/World.svg",F="/globo-quiz/assets/Africa.svg",z="/globo-quiz/assets/South_America.svg",O="/globo-quiz/assets/Asia.svg",K="/globo-quiz/assets/Europe.svg",G="/globo-quiz/assets/Oceania.svg",Z=[{key:"world",label:"Todo el mundo",icon:R},{key:"africa",label:"África",icon:F},{key:"america",label:"América",icon:z},{key:"asia",label:"Asia",icon:O},{key:"europe",label:"Europa",icon:K},{key:"oceania",label:"Oceanía",icon:G}];function N(){let a=[];function n(e){return a.includes(e)}function t(){const e=document.getElementById("continue-btn");a.length===0?(e.classList.add("bg-gray-200","text-gray-400","cursor-not-allowed"),e.classList.remove("bg-[#18b6fa]","text-white","shadow-md"),e.disabled=!0):(e.classList.remove("bg-gray-200","text-gray-400","cursor-not-allowed"),e.classList.add("bg-[#18b6fa]","text-white","shadow-md"),e.disabled=!1)}function s(){document.querySelector("#app").innerHTML=`
    ...
    `;return}let e=[],o=10,c=0,u=null,d=!1,m=!1,p=null,M=0;function $(){const l=s.filter(f=>!e.includes(f.country));if(l.length===0)return null;const i=P([...l])[0];e.push(i.country);const h=P(s.filter(f=>f.country!==i.country)).slice(0,3).map(f=>j[f.capital]||f.capital),r=P([j[i.capital]||i.capital,...h]);return{country:i.country,options:r,answer:j[i.capital]||i.capital}}function B(){window.renderHomePage()}function C(){var h;if(c>=o){k(M,o);return}p||(p=$());const l=p,i=(c+1)/o*100;document.querySelector("#app").innerHTML=`
        ...
        <div class="w-full max-w-[400px] flex flex-col h-full justify-between">
          <div>
            ...
            <div class="flex flex-col mb-2" style="gap:8px;">
              ${l.options.map((r,f)=>{let b="#e5e5e5",x="2px",w="6px",v=`border:${x} solid ${b};border-bottom-width:${w};transition:border-color 0.2s;`,A="10px",L="10px 14px",H="font-family:Inter, sans-serif;font-weight:600;font-size:18px;line-height:32px;",g="#4b4b4b",S="center",y="background:#fff;",V="cursor:pointer;";return d?r===l.answer?(b="#22c55e",g="#22c55e",y=u===r?"background:#d1fadf;":"background:#fff;",v=`border:${x} solid #22c55e;border-bottom-width:${w};`):u===r&&(b="#ef4444",g="#ef4444",y="background:#fee2e2;",v=`border:${x} solid #ef4444;border-bottom-width:${w};`):u===r&&(b="#38bdf8",g="#38bdf8",y="background:#e0f2fe;",v=`border:${x} solid #38bdf8;border-bottom-width:${w};`),`<div class="option-btn" data-opt="${r}" style="${v}border-radius:${A};padding:${L};${H}color:${g};${y}text-align:${S};${V}" onmouseover="this.style.borderColor='#84D8FF';this.style.color='#1899D6'" onmouseout="this.style.borderColor='${b}';this.style.color='${g}'">${r}</div>`}).join("")}
            </div>
            <div class="min-h-[24px] mb-1 text-center">
              ${d?m?'<span class="text-green-600 text-base font-bold">¡Correcto!</span>':`<span class="text-red-600 text-base font-bold">Error: es ${l.answer}</span>`:""}
            </div>
          </div>
    ...
    `,document.getElementById("back-btn").onclick=B,document.querySelectorAll(".option-btn").forEach(r=>{r.onclick=()=>{d||(u=r.getAttribute("data-opt"),C())}}),(h=document.getElementById("check-btn"))==null||h.addEventListener("click",()=>{d?(c++,u=null,d=!1,m=!1,p=$(),C()):(d=!0,m=u===l.answer,m&&M++,C())})}function k(l,i){document.querySelector("#app").innerHTML=`
      <div class="min-h-screen bg-white flex flex-col items-center px-4 pt-4 pb-2">
        <div class="w-full max-w-[400px]">
          ...
          <div class="flex flex-col items-center mt-8 mb-2">
            <img src="${E}" alt="Globo girando" style="height: 30vh; width: auto; max-width: 100%; object-fit: contain;" />
          </div>
    ...
    <div class="h-screen flex flex-col items-center justify-between bg-[#25305a] px-3 py-3">
      ...
      <img src="${Q}" alt="Globo animado" class="w-auto h-[40vh] max-h-[300px] object-contain" />
  ...
  `,document.getElementById("mode-capitales").onclick=()=>{window.selectedMode="capitals",N()},document.getElementById("mode-banderas").onclick=()=>{window.selectedMode="flags",N()}}window.renderHomePage=I;window.renderCapitalsMode=q;window.renderFlagsMode=D;I();
