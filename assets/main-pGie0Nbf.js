(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function t(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(e){if(e.ep)return;e.ep=!0;const o=t(e);fetch(e.href,o)}})();const I=[{key:"world",label:"Todo el mundo",icon:"/globo-quiz/public/world.svg"},{key:"africa",label:"África",icon:"/globo-quiz/public/Africa.svg"},{key:"america",label:"América",icon:"/globo-quiz/public/South_america.svg"},{key:"asia",label:"Asia",icon:"/globo-quiz/public/Asia.svg"},{key:"europe",label:"Europa",icon:"/globo-quiz/public/Europe.svg"},{key:"oceania",label:"Oceanía",icon:"/globo-quiz/public/Oceania.svg"}];function N(){let a=[];function i(e){return a.includes(e)}function t(){const e=document.getElementById("continue-btn");a.length===0?(e.classList.add("bg-gray-200","text-gray-400","cursor-not-allowed"),e.classList.remove("bg-[#18b6fa]","text-white","shadow-md"),e.disabled=!0):(e.classList.remove("bg-gray-200","text-gray-400","cursor-not-allowed"),e.classList.add("bg-[#18b6fa]","text-white","shadow-md"),e.disabled=!1)}function s(){document.querySelector("#app").innerHTML=`
        ...
        <div class="w-full max-w-[400px] flex flex-col h-full">
          ...
          <div class="flex-1 flex flex-col justify-center">
            <div class="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
              ${I.map((e,o)=>`
                <div class="flex items-center px-4 py-3 ${o!==0?"border-t border-gray-200":""} ${i(e.key)?"bg-blue-100 border-l-4 border-[#18b6fa]":""} cursor-pointer continent-row" data-key="${e.key}">
    ...
    `;return}let e=[],o=10,c=0,u=null,d=!1,g=!1,p=null,M=0;function $(){const l=s.filter(f=>!e.includes(f.country));if(l.length===0)return null;const n=S([...l])[0];e.push(n.country);const h=S(s.filter(f=>f.country!==n.country)).slice(0,3).map(f=>j[f.capital]||f.capital),r=S([j[n.capital]||n.capital,...h]);return{country:n.country,options:r,answer:j[n.capital]||n.capital}}function B(){window.renderHomePage()}function C(){var h;if(c>=o){k(M,o);return}p||(p=$());const l=p,n=(c+1)/o*100;document.querySelector("#app").innerHTML=`
            ...
            <div class="flex items-center mb-1">
              ...
              <div class="flex-1 mx-2">
                <div class="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                  <div class="h-2 bg-yellow-400 rounded-full transition-all duration-300" style="width: ${n}%;"></div>
                </div>
              </div>
    ...
    `,document.getElementById("back-btn").onclick=B,document.querySelectorAll(".option-btn").forEach(r=>{r.onclick=()=>{d||(u=r.getAttribute("data-opt"),C())}}),(h=document.getElementById("check-btn"))==null||h.addEventListener("click",()=>{d?(c++,u=null,d=!1,g=!1,p=$(),C()):(d=!0,g=u===l.answer,g&&M++,C())})}function k(l,n){document.querySelector("#app").innerHTML=`
      <div class="min-h-screen bg-white flex flex-col items-center px-4 pt-4 pb-2">
        <div class="w-full max-w-[400px]">
          <div class="flex items-center mb-2">
            ...
            <span class="text-gray-700 font-semibold text-lg ml-2" style="min-width: 40px;">${n}/${n}</span>
          </div>
    ...
    `,document.getElementById("back-btn").onclick=window.renderHomePage,document.getElementById("score-home-btn").onclick=window.renderHomePage}C()}window.renderCapitalsMode=E;async function F(){return(await(await fetch("https://restcountries.com/v3.1/all")).json()).filter(t=>t.flags&&t.flags.svg&&t.region&&t.name&&t.name.common).map(t=>{var s,e;return{country:((e=(s=t.translations)==null?void 0:s.spa)==null?void 0:e.common)||t.name.common,flag:t.flags.svg,continent:t.region.toLowerCase()}})}function T(a){for(let i=a.length-1;i>0;i--){const t=Math.floor(Math.random()*(i+1));[a[i],a[t]]=[a[t],a[i]]}return a}async function q(a){document.querySelector("#app").innerHTML="<div class='min-h-screen flex flex-col items-center justify-center bg-white'><span class='text-lg'>Cargando preguntas...</span></div>";let i=await F();const t={world:null,africa:"africa",america:"americas",asia:"asia",europe:"europe",oceania:"oceania"};let s=i;if(a.includes("world")||(s=i.filter(l=>a.some(n=>t[n]===l.continent))),s.length<10){document.querySelector("#app").innerHTML=`
      <div class='min-h-screen flex flex-col items-center justify-center bg-white'>
        <h2 class='text-2xl font-bold mb-4 text-center'>No hay suficientes países en los continentes seleccionados para un juego de 10 preguntas.</h2>
        <button class='btn btn-primary' onclick='window.renderHomePage()'>Volver al inicio</button>
      </div>
    `;return}let e=[],o=10,c=0,u=null,d=!1,g=!1,p=null,M=0;function $(){const l=s.filter(f=>!e.includes(f.country));if(l.length===0)return null;const n=T([...l])[0];e.push(n.country);const h=T(s.filter(f=>f.country!==n.country)).slice(0,3).map(f=>f.country),r=T([n.country,...h]);return{country:n.country,flag:n.flag,options:r,answer:n.country}}function B(){window.renderHomePage()}function C(l,n){document.querySelector("#app").innerHTML=`
      <div class="min-h-screen bg-white flex flex-col items-center px-4 pt-4 pb-2">
        <div class="w-full max-w-[400px]">
          <div class="flex items-center mb-2">
            <button id="back-btn" class="p-2 -ml-2">
          ...
          <div class="flex flex-col items-center mt-8 mb-2">
            <img src="/globo-quiz/public/earth-score.gif" alt="Globo girando" style="height: 30vh; width: auto; max-width: 100%; object-fit: contain;" />
          </div>
          <div class="text-center text-2xl font-extrabold text-gray-800 mb-6">¡Fin de la partida!</div>
          <div class="w-full flex justify-center mb-10">
            <div style="border:3px solid #d1aaff; border-radius:16px; background:#f8f5ff; padding:24px 0; width:100%; max-width:370px; text-align:center;">
    ...
    `,document.getElementById("back-btn").onclick=window.renderHomePage,document.getElementById("score-home-btn").onclick=window.renderHomePage}function k(){var h;if(c>=o){C(M,o);return}p||(p=$());const l=p,n=(c+1)/o*100;document.querySelector("#app").innerHTML=`
      <div class="h-screen bg-white flex flex-col items-center px-2 py-2 justify-between">
        <div class="w-full max-w-[400px] flex flex-col h-full justify-between">
          <div>
            <div class="flex items-center mb-1">
    ...
    <div class="h-screen flex flex-col items-center justify-between bg-[#25305a] px-3 py-3">
      ...
      <img src="/globo-quiz/public/globo-quiz-globe.gif" alt="Globo animado" class="w-auto h-[40vh] max-h-[300px] object-contain" />
